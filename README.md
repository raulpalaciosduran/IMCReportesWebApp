...
- Registro de peso, altura, fecha y cálculo de IMC
...
- `reportes.html` → Visualización de reportes IMC
...
**Raúl Palacios Durán**  
Estudiante de Ingeniería en Computación Administrativa  
Universidad TecMilenio  
Materia: Computación Avanzada en Java  
Mentor digital y arquitecto modular

---

> Proyecto desarrollado con fines educativos. Código disponible para consulta, réplica y mejora institucional.
